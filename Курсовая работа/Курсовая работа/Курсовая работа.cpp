...
void ProstayaIteraciya() {
	...
	a1 = a2 = a3 = 1;
	b1 = b2 = b3 = 0;
	while (abs(b1 - a1) > e || abs(b2 - a2) > e || abs(b3 - a3) > e ) {
		a1 = b1; a2 = b2; a3 = b3;
		b1 = (mat[0][3] - (mat[0][1] * a2 + mat[0][2] * a3 )) / mat[0][0];
		b2 = (mat[1][3] - (mat[1][0] * a1 + mat[1][2] * a3 )) / mat[1][1];
		b3 = (mat[2][3] - (mat[2][0] * a1 + mat[2][1] * a2 )) / mat[2][2];
	}
...
void Zeydelya() {
	...
	while (abs(b1 - a1) > e || abs(b2 - a2) > e || abs(b3 - a3) > e) {
		a1 = b1; a2 = b2; a3 = b3;
		b1 = (mat[0][3] - (mat[0][1] * a2 + mat[0][2] * a3)) / mat[0][0];
		b2 = (mat[1][3] - (mat[1][0] * b1 + mat[1][2] * a3)) / mat[1][1];
		b3 = (mat[2][3] - (mat[2][0] * b1 + mat[2][1] * b2)) / mat[2][2];
	}
